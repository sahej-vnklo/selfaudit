import { createArea, createMetricDefinition, createThresholdRule, createRulePack, createMetricMapping } from '../schema.js'

const ALL_INDUSTRIES = [
  'saas-software','ecommerce-d2c','marketplace-platform','consumer-app','professional-services',
  'life-sciences','manufacturing','wholesale-distribution','logistics-freight','retail',
  'retail-hospitality','hospitality-fb','healthcare','real-estate','construction','agriculture',
  'fintech-finance','insurance','telecommunications','media-creator','education','energy-utilities','other',
]
...
// ─── Full extended catalog map ────────────────────────────────────────────────

export const AREA_CATALOG_EXTENDED = {
